...
<html>
  ...
  <div class="banner">
    ...
    <br>
    <h4>您当前的位置:	<a href="index.jsp">首页 </a>	>	计算</h4>
	<br><br><br>
		<input id="b2" type="text"  placeholder="b2">
		<input id="b3" type="text"  placeholder="b3">
		<input id="b4" type="text"  placeholder="b4">
		<input id="b5" type="text"  placeholder="b5">
		<input id="b6" type="text"  placeholder="b6">
		<input id="b7" type="text"  placeholder="b7">
		<input id="b8" type="text"  placeholder="b8">
		<input id="b42" type="text"  placeholder="b42">
		<input id="b45" type="text"  placeholder="b45">
		<input id="b48" type="text"  placeholder="b48">
		<br><br>		
		<button type="submit" class="btn btn-primary btn-lg" onclick="calculate()">
	  		计算
	  	</button>
	  	<br><br>
	  	<h3>结果</h3><input id="c49" type="text"  placeholder="c49" readonly><input id="c53" type="text"  placeholder="c53" readonly>
    </div>
...
//			$('.navbar navbar-inverse navbar-fixed-top').stickUp();
		...
		document.onkeydown(function(){
		  ...
		  function calculate() {
			  ...
			  var d1 = Math.PI * b6 / 180;
			  var d2 = 45 - b6 / 2;
			  var d3 = Math.PI * d2 / 180;
			  var d4 = b2 / 2 * Math.tan(d3);
			  var d5 = b5 / Math.cos(b6);
			  var d6 = d4 - d5;
			  var d7 = b3 * Math.tan(b6 * Math.PI / 180);
			  var d8 = b4 - 2 * (d7 + d6) - b2;
			  var b9 = d8;
			  var d9 = b2 / 2 - b5 / 2 - 0.01;
			  var d10 = d9 * Math.cos(Math.PI * b6 / 180);
			  var d11 = b4 / 2 - b2 / 2 - d10;
			  var d12 = 2*d10*3.14*1.2;
			  var d13 = d12*Math.sin(Math.PI*b6/180);
			  var d14 = d11 + d13;
			  var d15 = d14/Math.sin(Math.PI*b6/180);
			  var d16 = Math.ceil(d15*2)/2;
			  var d17 = d12*Math.cos(Math.PI*b6/180);
			  var d18 = parseFloat(d17) + parseFloat(b3);
			  var d19 = d18/Math.cos(Math.PI*b6/180);
			  var d20 = parseFloat(d19)+parseFloat(b7)+parseFloat(0.5);
			  var d21 = Math.ceil(d20*2)/2;
			  var d22 = d16-d21;
			  var d23 = 360*Math.sin(d1);
			  var d24 = Math.PI*d23/2/180;
			  var d25 = d22*d22-b8/2;
			  var d26 = Math.sqrt(d25);
			  var d27 = b8/2*Math.tan(d24);
			  var d28 = d26-d27;
			  alert(d28);
			  
			  var d29 = d28*Math.cos(d23/2*Math.PI/180);
			  var d30 = (b8/2-3)/Math.tan(d24);
			  var d31 = (b8/2-3)/Math.sin(d24);
			  var d32 = (d22+3+d30)*Math.cos(d24);
			  var d33 = d32-3-d29-d31;
			  var d34 = parseFloat(d33)+parseFloat(d29);
			  var d35 = parseFloat(d34)+parseFloat(d16);
			  var d36 = d35*Math.tan(d24);
			  var d37 = b8/Math.cos(d24);
			  var d38 = parseFloat(d37)+parseFloat(d36);
			  var d39 = d16*d16-b8/2;
			  var d40 = Math.sqrt(d39);
			  var d41 = (parseFloat(d40)+parseFloat(b8/2/Math.tan(d24)))*Math.sin(d24);
			  var d42 = d16*d16-(b8-b42)*(b8-b42);
			  var d43 = Math.sqrt(d42);
			  var d44 = (parseFloat(d43)+parseFloat((b8/2-b42)/Math.tan(d24)))*Math.sin(d24);
			  var d45 = d36;
			  var d46 = (parseFloat(b8)+parseFloat(b45))/Math.cos(d24);
			  var d47 = parseFloat(d46)+parseFloat(d45);
			  var d48 = (b48-d41*2)/d47;
			  var d49 = Math.floor(d48);
			  var d50 = parseFloat(d44)+parseFloat(d38)+parseFloat(d47)+parseFloat(d41);
			  var d51 = parseFloat(d44)+parseFloat(d38)+parseFloat(d47)+parseFloat(d38)+parseFloat(d44);
			  var d52 = parseFloat(d44)+parseFloat(d38)+parseFloat(d47)+parseFloat(d38)+parseFloat(d47)+parseFloat(d41);
			  var d53;
			  document.getElementById("c49").value = parseFloat(d49) + parseFloat(1);
			  if (c49 == 3) {
				  d53 = d50;
			  } else {
				  if (c49 = 4) {
			  ...
			  document.getElementById("c53").value = Math.ceil(d53*2)/2;
			  //alert(b1);
		  }
	</script>
    </body>
