...
<html>
  ...
  <body class="default-bg" role="document">
    ...
    <br>
    <h4>您当前的位置:	<a href="index.jsp">首页 </a>	>	提交反馈</h4>
    	<div class="section">
    		<div class="page-header">
    			<h1>用户反馈</h1>
    		</div>
    	</div>
    	<form id="form" action="submitFeed" method="post" class="form-horizontal" role="form">
    		<div class="form-group">
    			<div class="row">   			
				   		<textarea id="feedback" name="content" class="form-control" check-type="required" rows="8"></textarea>						
				</div>
			</div>
			<div class="row">
	...
	<script>
		...
		$("#submit").on('click',function(event){
		      ...
		      //  valide(msg)
		      if ($("#form").valid(this,'请输入内容')==false){
		        return false;
		      }
		    });
