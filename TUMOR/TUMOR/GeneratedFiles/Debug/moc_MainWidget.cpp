...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CMainWidget_t, stringdata) + ofs \
...
const QMetaObject CMainWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_CMainWidget.data,
...
void *CMainWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CMainWidget.stringdata))
        return static_cast<void*>(const_cast< CMainWidget*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions_4_3_Core"))
        return static_cast< QOpenGLFunctions_4_3_Core*>(const_cast< CMainWidget*>(this));
